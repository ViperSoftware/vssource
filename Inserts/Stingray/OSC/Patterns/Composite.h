...
#ifndef __SECCOMPOSITE_PATTERN_H__
#define __SECCOMPOSITE_PATTERN_H__
...
template <class element_t>
void IteratorPreOrder_T<element_t>::First() {
...
template <class element_t>
void IteratorPreOrder_T<element_t>::Last() {
...
template <class element_t>
void IteratorPreOrder_T<element_t>::Next() {
...
template <class element_t>
void IteratorPreOrder_T<element_t>::Prev() {
...
public:
	...
	virtual element_t GetParent() { return m_pParent; }
...
public:
	...
	virtual void iInsert(CCIterPos*,element_t) 			{ ASSERT(FALSE); }
...
// Return number of children in composite
template <class element_t>
int SECComposite_T<element_t>::GetChildCount(BOOL bRecursive) {
...
#endif	//__SECCOMPOSITE_PATTERN_H__
