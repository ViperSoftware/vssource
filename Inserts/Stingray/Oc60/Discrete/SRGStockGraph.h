...
/////////////////////////////////////////////////////////////
//@doc SRGStockGraph
//@module SRGStockGraph.h|  definition of the Stock and Area Stock graph display class<nl>
//Copyright <cp>Stingray Software 1996<nl>
//Written by Bob Powell (www.stingray.com)

/////////////////////////////////////////////////////////////
//
// SRGStockGraph.h: definition of the Stock and Area Stock graph display class
//
/////////////////////////////////////////////////////////////
...
#ifndef __SRGStockGraph__
#define __SRGStockGraph__


////////////////////////////////////////////////////////
// Autoduck comment block for SRGStockGraph
//
//@doc SRGStockGraph


// adinsert SRGStockGraph

////////////////////////////////////////////////////////

//@doc SRGStockGraph
//@class Performs data drawing for Stock and Area Stock graph types<nl>
...
//This class defines all DrawXXXData functions -- only the DrawStockData function does anything useful.
...
public:
	...
	virtual ~SRGStockGraph();

//@access Protected member functions
protected:

	//@cmember Called to draw stock quote hi-lo-close graphs
