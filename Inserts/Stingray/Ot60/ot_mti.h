...
// 
//  Author:			Rob Oliver
//  Description:	ot_mti.h - MTI (MDI alternative) component header
//  Created:		Tue Aug 27 14:08:25 1998
//
//

#ifndef __OTM_MTI_H__
#define  __OTM_MTI_H__
...
#else
	#pragma message("Warning:  MTI support was not included in the Objective Toolkit library.")
