...
//		All these styles use the high-order 12 bits...
...
//@doc SEC_LISTCLASS
//@mfunc virtual int | SEC_LISTCLASS | GetSubItemHit | Returns the subitem number for a given column.
//@parm  int | nHitCol | column number to retrieve the subitem for.


//@doc SEC_LISTCLASS
//@mfunc inline CDWordArray*  | SEC_LISTCLASS | GetSelectionArray | Returns a pointer to the array of selected items. Each item in the array is an index.


//@doc 
//@mfunc virtual BOOL  |  SEC_LISTCLASS | AreSysColorsTracked | Returns the state of system color tracking. See EnableSysColorTracking.


//@doc 
//@mfunc virtual void  |  SEC_LISTCLASS | EnableSysColorTracking | Enables or disables the effects of a WM_SYSCOLORCHANGE message.
//@parm  BOOL | bEnable | TRUE to enable system color tracking, FALSE to disable. Default TRUE.
//@comm   If enabled,  a WM_SYSCOLORCHANGE message will cause all colors to be refreshed from the default system colors. This
// will overwrite any color settings that were previously set using SetBkColor, SetTextColor, etc. By default, the control
// will not track system colors.
...
// It is not meant for external use, and is documented primarily for the inherited funtions that
// tree control users may need.
