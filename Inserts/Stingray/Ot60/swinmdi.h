...
//
// See the \OT\SAMPLES\STANDARD\DOCKING\VIZ and \OT\SAMPLES\STANDARD\UIEXT\GRADFRM samples, which demonstrate the capabilities of this class.
...
public:
	...
	//@cmember
	/* Enable calling of CView::OnActivateView, see remarks*/
	void EnableOnActivateView(BOOL bEnable=TRUE);
...
protected:
	...
	SECWndPlugIn * m_pMenuBarFeature;
	BOOL           m_bBmpMenu;
...
//
// See the SCRIBBLE sample in the \OT\SAMPLES\STANDARD\MDI\MT_SCRIB directory for a 
