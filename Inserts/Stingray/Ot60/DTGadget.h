...
public:
	...
	virtual void GetText(LPTSTR lpszBuf);
...
{
	DECLARE_DYNCREATE(SECDTStaticGadget)
...
{
	DECLARE_DYNCREATE(SECDTNumericGadget)
...
{
	DECLARE_DYNCREATE(SECDTListGadget)
...
{
	DECLARE_DYNCREATE(SECDTButtonGadget)
...
{
	DECLARE_DYNCREATE(SECDTSpinGadget)
