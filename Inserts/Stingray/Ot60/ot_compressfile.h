...
// 
//  Author:			Rob Oliver
//  Description:	ot_compressfile.h - File compression component header
//  Created:		Tue Aug 27 14:08:25 1998
//
//

#ifndef __OTM_COMPRESSFILE_H__
#define  __OTM_COMPRESSFILE_H__
...
#else
	#pragma message("Warning:  The file compression component was not included in the Objective Toolkit library.")
