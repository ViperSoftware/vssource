...
// 
//  Author:			Rob Oliver
//  Description:	ot_tipoftheday.h - Keyboard shortcut component header
//  Created:		Tue Aug 27 14:08:25 1998
//
//

#ifndef __OTM_TIPOFTHEDAY_H__
#define  __OTM_TIPOFTHEDAY_H__
...
#else
	#pragma message("Warning:  The tip of the day component was not included in the Objective Toolkit library.")
