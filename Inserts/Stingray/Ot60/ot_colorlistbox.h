...
// 
//  Author:			Rob Oliver
//  Description:	ot_colorlistbox.h - Color listbox component header
//  Created:		Tue Aug 27 14:08:25 1998
//
//

#ifndef __OTM_COLORLISTBOX_H__
#define  __OTM_COLORLISTBOX_H__
...
#else
	#pragma message("Warning:  The color listbox control was not included in the Objective Toolkit library.")
